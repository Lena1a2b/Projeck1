...
class Main15Test {
    @Test
        //Проверка кликабельности ссылки "Интенсивные курсы" в меню " Онлайн-курсы"
    void main() throws InterruptedException {
        ...
        menu.click( );
        Thread.sleep(9500);
        WebElement menu1 = driver.findElement(By.xpath("/html/body/div[2]/div[5]/div[2]/div/div[3]/ul/li[6]/div/a/span"));
        menu1.click( );
        Thread.sleep(9500);
        driver.quit( );
