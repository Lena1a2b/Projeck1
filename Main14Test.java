...
class Main14Test {
    @Test
        //Проверка кликабельности ссылки "Python" в меню " Онлайн-курсы"
    void main() throws InterruptedException {
        ...
        menu.click( );
        Thread.sleep(9500);
        WebElement menu1 = driver.findElement(By.xpath("/html/body/div[2]/div[5]/div[2]/div/div[3]/ul/li[5]/div/a"));
        menu1.click( );
        Thread.sleep(9500);
        driver.quit( );
